...
pub trait UsableZnRing<I: IntegerRingStore>: ZnRing + CanHomFrom<I::Type> + CanHomFrom<BigIntRingBase>
    where I::Type: IntegerRing, Self::IntegerRingBase: CanonicalIso<I::Type> 
{}

impl<I: IntegerRingStore, T: ?Sized + ZnRing + CanHomFrom<I::Type> + CanHomFrom<BigIntRingBase>> UsableZnRing<I> for T
    where I::Type: IntegerRing, T::IntegerRingBase: CanonicalIso<I::Type> 
{}
...
pub struct PrimeDecomposition<'a, F: ZnRingStore, T1: ZnRingStore, T2: ZnRingStore, T3: ZnRingStore, I>
    where I: IntegerRingStore,
        I::Type: IntegerRing + CanonicalIso<StaticRingBase<i64>>,
        F::Type: ZnRing + CanHomFrom<I::Type> + CanHomFrom<BigIntRingBase>,
        <F::Type as ZnRing>::IntegerRingBase: CanonicalIso<I::Type>,
        T1::Type: UsableZnRing<I>, <T1::Type as ZnRing>::IntegerRingBase: CanonicalIso<I::Type>,
        T2::Type: UsableZnRing<I>, <T2::Type as ZnRing>::IntegerRingBase: CanonicalIso<I::Type>,
        T3::Type: UsableZnRing<I>, <T3::Type as ZnRing>::IntegerRingBase: CanonicalIso<I::Type>
{
    from: F,
    to: (&'a [T1], &'a [T2], &'a [T3]),
...
pub struct PrimeDecomposeVec<'a, F: ZnRingStore, T: ZnRingStore, I, const m: usize>
    where I: IntegerRingStore,
        ...
        <F::Type as ZnRing>::IntegerRingBase: CanonicalIso<I::Type>,
        T::Type: UsableZnRing<I>, <T::Type as ZnRing>::IntegerRingBase: CanonicalIso<I::Type>
{
    lift: [El<I>; m],
        ...
        T3::Type: UsableZnRing<I>, <T3::Type as ZnRing>::IntegerRingBase: CanonicalIso<I::Type>
{
    ...
    fn initialize<T: ZnRingStore>(from: &F, to: &[T], int_ring: &I, P: &El<BigIntRing>, gamma: &El<I>, unit_vectors: &mut Vec<El<F>>, inv_unit_vectors: &mut Vec<El<T>>, correction_unit_vectors: &mut Vec<El<I>>)
        where T::Type: UsableZnRing<I>, <T::Type as ZnRing>::IntegerRingBase: CanonicalIso<I::Type>
    {
        for i in 0..to.len() {
    ...
    fn direct_decompose_multiple<T: ZnRingStore, const m: usize>(&self, el: [El<F>; m], i: usize, rings: &[T]) -> [El<T>; m] 
        where T::Type: UsableZnRing<I>, <T::Type as ZnRing>::IntegerRingBase: CanonicalIso<I::Type>
    {
        core::array::from_fn(|j| self.direct_decompose(self.from.clone_el(&el[j]), i, rings))
    }

    pub fn direct_decompose0_multiple<const m: usize>(&self, el: [El<F>; m], i: usize) -> [El<T1>; m] {
        self.direct_decompose_multiple(el, i, &self.to.0)
    }
    
    pub fn direct_decompose1_multiple<const m: usize>(&self, el: [El<F>; m], i: usize) -> [El<T2>; m] {
        self.direct_decompose_multiple(el, i, &self.to.1)
    }

    pub fn direct_decompose2_multiple<const m: usize>(&self, el: [El<F>; m], i: usize) -> [El<T3>; m] {
        self.direct_decompose_multiple(el, i, &self.to.2)
    }
